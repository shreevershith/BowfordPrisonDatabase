...
$Query1 = "SELECT COUNT(*) FROM section WHERE SECTION_ID = '$sid'";
...
{
    $Query2 =  "DELETE FROM section WHERE SECTION_ID= '$sid'";
...
<head>
  ...
  <title>DELETE SECTION TABLE ROWS</title>
</head>
<style>
...
<center><p>
 <br><h3 style= "color:#5effae;font-family:courier;font-size:200%;text-align:center;">DELETE SECTION_INFO:<br><br></h3>
 </p></center>
 <center>
  <div align = "center">
    <form action="secdel.php" method="post">
