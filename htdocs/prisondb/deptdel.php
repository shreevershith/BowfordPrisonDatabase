...
$Query1 = "SELECT COUNT(*) FROM department WHERE DEPARTMENT_NO = $dno";
...
{
    $Query2 =  "DELETE FROM department WHERE DEPARTMENT_NO= $dno";
...
<head>
  ...
  <title>DELETE DEPARTMENT TABLE ROWS</title>
</head>
<style>
...
<center><p>
 <br><h3 style= "color:#5effae;font-family:courier;font-size:200%;text-align:center;">DELETE DEPARTMENT_INFO:<br><br></h3>
 </p></center>
 <center>
