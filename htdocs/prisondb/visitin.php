...
<head>
  ...
  <title>INSERT VISITOR TABLE </title>
</head>
<style>
...
<center><p>
 <br><h3 style= "color:#5effae;font-family:courier;font-size:200%;text-align:center;">INSERT NEW VISITOR INFO:<br><br></h3>
 </p></center>
  <center><div align = "center">
    <form action="visitin.php" method="post">
...
if (isset($_POST['submit']))
{
    ...
    $sql =  "INSERT INTO  visitor(VISITOR_NAME,VISITOR_ID,PRISONER_ID)
VALUES ('$vnam',$vid,'$pid')";
    if ($conn->query($sql) === TRUE) {
      ?> <script type="text/javascript">alert("New record inserted Successfully!!")</script><?php
    } else{
      ?> <script type="text/javascript">alert("ERROR while inserting record.....")</script><?php
    }
